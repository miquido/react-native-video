...
class ReactExoplayerViewManager(private val config: ReactExoplayerConfig) : ViewGroupManager<ReactExoplayerView>() {
    ...
    companion object {
        ...
        private const val PROP_PREVENTS_DISPLAY_SLEEP_DURING_VIDEO_PLAYBACK = "preventsDisplaySleepDuringVideoPlayback"
        ...
        private const val PROP_SUBTITLE_LINES_RESPECTED = "subtitleLinesRespected"
        ...
        private const val PROP_COOKIE_POLICY = "cookiePolicy"
    ...
    @ReactProp(name = ReactExoplayerViewManager.PROP_SUBTITLE_LINES_RESPECTED, defaultBoolean = true)
    fun setSubtitleLinesRespected(videoView: ReactExoplayerView, linesRespected: Boolean) {
    ...
    fun setCookiePolicy(videoView: ReactExoplayerView, cookiesPolicy: String?) {
        videoView.setCookiePolicy(cookiesPolicy)
    }
